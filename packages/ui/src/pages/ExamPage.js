...
export function ExamPage({ session, setSession }) {
    ...
    const layout = (_jsxs(PageShell, { className: "py-0 pb-24 lg:pb-10", children: [_jsxs(Card, { className: "mt-4 space-y-3", children: [_jsxs("div", { children: [_jsxs("h1", { className: "text-lg font-semibold text-text", children: [examTitle, config?.subject ? ` — ${config.subject}` : ""] }), _jsx("p", { className: "text-sm text-textMuted", children: "Answer questions and submit when done." })] }), timeLimitMinutes ? (_jsxs("div", { className: "flex flex-wrap items-center gap-2 text-sm", children: [_jsx(Badge, { tone: timeExpired ? "warn" : "info", children: timeRemainingMs === null ? "Time limit" : formatTimeRemaining(timeRemainingMs) }), _jsxs("span", { className: "text-xs text-textMuted", children: ["Limit: ", timeLimitMinutes, " minutes"] })] })) : null, _jsx(StepIndicator, { steps: startSteps }), _jsx("div", { role: "status", "aria-live": "polite", className: "text-xs text-textMuted min-h-[1.25rem]", children: draftNotice ?? "" })] }), submission ? (_jsxs(Card, { className: "mt-4 space-y-2", children: [_jsxs("div", { className: "flex items-center justify-between", children: [_jsx("div", { className: "text-sm font-semibold text-text", children: "Score" }), _jsxs(Badge, { tone: "success", children: [submission.score.correct, "/", submission.score.total] })] }), _jsx("div", { className: "text-sm text-textMuted", children: "Submission recorded." }), signedIn ? (_jsx(Link, { to: "/history", className: "inline-flex", children: _jsx(Button, { variant: "secondary", size: "sm", children: "View in My History" }) })) : null] })) : null, status ? _jsx(Alert, { tone: status.tone, className: "mt-3", children: status.text }) : null, _jsxs("div", { className: "grid gap-4 lg:grid-cols-[2fr,1fr] mt-4", children: [_jsxs("div", { className: "space-y-4", children: [config?.notice ? (_jsx(Card, { className: "border-info/30 bg-info/5 dark:bg-info/10", children: _jsxs("div", { className: "flex items-start gap-3", children: [_jsx("div", { className: "mt-0.5 text-info", children: _jsx("svg", { xmlns: "http://www.w3.org/2000/svg", className: "h-5 w-5", viewBox: "0 0 20 20", fill: "currentColor", children: _jsx("path", { fillRule: "evenodd", d: "M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z", clipRule: "evenodd" }) }) }), _jsxs("div", { className: "flex-1", children: [_jsx("h3", { className: "text-sm font-semibold text-info", children: "Notice" }), _jsx("div", { className: "mt-1 text-sm text-neutral-800 dark:text-neutral-200", children: _jsx(LatexContent, { content: config.notice }) })] })] }) })) : null, bank ? (bank.questions.map((q, idx) => {
                                ...
                                const fullQuestion = pq ? {
                                    ...q,
                                    answerKey: pq.answerKey ?? q.answerKey,
                                    solution: pq.solution ?? q.solution,
                                    answers: pq.expected ?? q.answers
                                } : q;
                                return (_jsx("div", { id: `q-${idx + 1}`, children: q.type === "mcq-single" ? (_jsx(McqQuestion, { index: idx, question: fullQuestion, answer: typeof answers[q.uid] === "string" ? answers[q.uid] : "", onChange: (uid, val) => setAnswers((prev) => ({ ...prev, [uid]: val })), showSolution: showSolutions && config?.policy.solutionsMode !== "never", submissionStatus: submissionStatus })) : q.type === "fill-blank" ? (_jsx(FillBlankQuestion, { index: idx, question: fullQuestion, answer: answers[q.uid], onChange: (uid, val) => setAnswers((prev) => ({ ...prev, [uid]: val })), showSolution: showSolutions && config?.policy.solutionsMode !== "never", submissionStatus: submissionStatus })) : null }, q.uid));
                            })) : (_jsxs(Card, { className: "space-y-3", children: [_jsxs("div", { children: [_jsx("p", { className: "text-sm font-semibold text-text", children: "Questions not loaded" }), _jsx("p", { className: "text-sm text-textMuted", children: "Use the controls at the top to get started." })] }), _jsxs("ol", { className: "text-sm text-textMuted list-decimal pl-5 space-y-1", children: [_jsx("li", { children: "If required, sign in and enter your access code." }), _jsxs("li", { children: ["Click ", _jsx("strong", { children: "Load questions" }), "."] })] })] }))] }), _jsxs("div", { className: "space-y-4", children: [authMode === "required" ? (_jsxs(Accordion, { title: "Authentication", defaultOpen: true, tone: "muted", children: [_jsxs("div", { className: "flex gap-2 flex-wrap", children: [_jsx(Button, { variant: "secondary", size: "sm", onClick: handleGithub, children: "GitHub Login" }), _jsx(Button, { variant: "secondary", size: "sm", onClick: handleGoogle, children: "Google Login" })] }), _jsx("div", { className: "text-xs text-textMuted", children: "Sign in to access this exam." }), _jsxs("div", { className: "text-xs text-textMuted", children: ["Current session: ", session ? session.provider : "none"] })] })) : null, _jsxs(Card, { className: "sticky top-24 space-y-3", children: [_jsx("div", { className: "text-xs text-textMuted uppercase tracking-wider font-bold", children: "Navigation" }), _jsx("div", { className: "flex flex-wrap gap-2", children: Array.from({ length: totalQuestions }).map((_, i) => {
                                            const idx = i + 1;
                                            const answered = !!answers[bank?.questions[i]?.uid ?? ""];
                                            return (_jsx("button", { className: clsx("w-8 h-8 rounded-md border text-xs font-semibold transition-all", answered
                                                    ? "bg-info/10 border-info/50 text-info"
                                                    : "bg-muted border-border text-textMuted hover:border-info/30"), onClick: () => document.getElementById(`q-${idx}`)?.scrollIntoView({ behavior: "smooth", block: "start" }), children: idx }, idx));
                                        }) }), canShare ? (_jsx(Button, { variant: "secondary", size: "sm", onClick: handleShare, className: "w-full mt-2 text-xs", children: "Share exam link" })) : null] })] })] })] }));
    if (loading) {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(StickyHeader, { examId: config.examId, subject: config.subject, title: config.title ?? null, progressPct: completionPct, answered: answeredCount, total: totalQuestions || config.composition.reduce((acc, i) => acc + i.n, 0), status: status?.text, bankLoaded: !!bank, onLoadQuestions: handleBank, onClearAnswers: openClearAnswersConfirm, onSave: handleSaveForLater, onSubmit: openSubmitConfirm, onScrollTop: scrollToTop, onScrollBottom: scrollToBottom, onReviewUnanswered: reviewUnanswered, loadDisabled: loadDisabled, clearDisabled: !bank || !!submission, saveDisabled: !bank || !versionId, submitDisabled: submitDisabled, viewCode: viewCode, onViewCodeChange: setViewCode, submitCode: submitCode, onSubmitCodeChange: setSubmitCode, requireViewCode: requireViewCode, requireSubmitCode: requireSubmitCode, timeRemainingLabel: timeLimitMinutes ? formatTimeRemaining(timeRemainingMs ?? 0) : null, timeExpired: timeExpired }), layout, confirmOpen ? (_jsxs("div", { className: "fixed inset-0 z-50 flex items-center justify-center p-4", children: [_jsx("div", { className: "absolute inset-0 bg-black/40", onClick: () => setConfirmOpen(false) }), _jsxs(Card, { className: "relative w-full max-w-md space-y-3", children: [_jsx("div", { className: "text-base font-semibold text-text", children: "Submit answers?" }), _jsxs("div", { className: "text-sm text-textMuted", children: ["You answered ", answeredCount, "/", totalQuestions || "?", ". Submit now?"] }), _jsxs("div", { className: "flex justify-end gap-2", children: [_jsx(Button, { variant: "secondary", onClick: () => setConfirmOpen(false), children: "Cancel" }), _jsx(Button, { onClick: () => {
                                            setConfirmOpen(false);
                                            void handleSubmit();
