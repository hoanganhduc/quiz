...
export function StickyHeader({ examId, subject, progressPct, answered, total, status }: Props) {
  return (
      ...
      <Card padding="sm" className="flex flex-col gap-2 shadow-none border-none">
        <div className="flex items-center justify-between flex-wrap gap-2">
          <div>
            ...
            <div className="font-semibold text-base text-neutral-900 dark:text-neutral-100">{examId}</div>
